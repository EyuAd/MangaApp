...
var _getEnv = (useShim) => {
  var _a, _b;
  return ((_a = globalThis.process) == null ? void 0 : _a.env) || //@ts-expect-error
  ((_b = globalThis.Deno) == null ? void 0 : _b.env.toObject()) || //@ts-expect-error
...
var createLogger = (options) => {
  ...
  const isDisableColorsSpecified = (options == null ? void 0 : options.disableColors) !== void 0;
...
var getClientConfig = (options, loadEnv) => {
  ...
  const baseURL = getBaseURL(options == null ? void 0 : options.baseURL, options == null ? void 0 : options.basePath, void 0, loadEnv) ?? "/api/auth";
  ...
  const { onSuccess, onError, onRequest, onResponse, ...restOfFetchOptions } = (options == null ? void 0 : options.fetchOptions) || {};
  ...
  for (const plugin of plugins) {
    if (plugin.getAtoms) {
      Object.assign(pluginsAtoms, (_f = plugin.getAtoms) == null ? void 0 : _f.call(plugin, $fetch));
    }
  ...
  for (const plugin of plugins) {
    if (plugin.getActions) {
      Object.assign(
        pluginsActions,
        (_g = plugin.getActions) == null ? void 0 : _g.call(plugin, $fetch, $store, options)
      );
    }
  }
  return {
...
function getMethod2(path, knownPathMethods, args) {
  ...
  if (fetchOptions == null ? void 0 : fetchOptions.method) {
