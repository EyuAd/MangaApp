...
const Register = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(err.message || err.statusText || 'Registration failed. Please try again.');
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-50 relative overflow-hidden">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute -bottom-[20%] -left-[10%] w-[50%] h-[50%] bg-purple-200/30 rounded-full blur-3xl" />
                <div className="absolute top-[20%] -right-[10%] w-[40%] h-[40%] bg-orange-200/30 rounded-full blur-3xl" />
            </div>

            <div className="bg-white p-8 md:p-10 rounded-2xl shadow-xl w-full max-w-md relative z-10 border border-gray-100">
                <div className="text-center mb-8">
                    <h1 className="text-3xl font-black text-gray-900 tracking-tight mb-2">Join Manga-LOB</h1>
                    <p className="text-gray-500">Create an account to start reading.</p>
                </div>
